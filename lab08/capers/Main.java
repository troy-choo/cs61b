...
public class Main {
    ...
    public static void writeStory(String[] args) {
        ...
        if (storyFile.exists()) {
            Utils.writeContents(storyFile, Utils.readContentsAsString(storyFile) + args[1] + "\n");
        } else {
            Utils.writeContents(storyFile, args[1] + "\n");
        }
    ...
    public static void makeDog(String[] args) {
        ...
        try {
            ...
            exitWithError("Invalid age: " + args[3]);
            return;
        }
    ...
    public static void celebrateBirthday(String[] args) {
        ...
        if (dog == null) {
            exitWithError("Dog not found: " + name);
            return;
        }
